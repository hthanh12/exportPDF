...
exports.create = async (ctx) => {
  try {
    ...
    ctx.response.attachment(`Candidate-${_.startCase(dataSample.name)}-${moment().format('DDMMYY_HHmmss')}.pdf`)
...
let dataSample = {
  name : "test",
  src: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Up_%282009_film%29_logo.svg/1200px-Up_%282009_film%29_logo.svg.png"
}